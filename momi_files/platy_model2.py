...
#Modelo 2 - sem expansão, com migração em todas as direções
...
#platy_model2.add_size_param("n_AF", lower=5e3, upper=1e6)
#platy_model2.add_size_param("n_CEP", lower=5e3, upper=1e6)
...
#platy_model2.add_size_param("n_Andes", lower=5e3, upper=1e6)
